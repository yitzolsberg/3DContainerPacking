...
namespace ContainerPacking2.Algorithms
{
	...
	public class EB_AFIT : IPackingAlgorithm
	{
		...
		private long packedy;
		private long prelayer;
		private long prepackedy;
		private long preremainpy;
		private long px;
		private long py;
		private long pz;
		private long remainpy;
		private long remainpz;
		private long itemsToPackCount;
		private long totalItemVolume;
		private long totalContainerVolume;
		...
		/// </summary>
		private void AnalyzeBox(long hmx, long hy, long hmy, long hz, long hmz, long dim1, long dim2, long dim3)
		{
		...
		/// </summary>
		private void FindBox(long hmx, long hy, long hmy, long hz, long hmz)
		{
			int y;
			bfx = 32767;
			bfy = 32767;
		...
		/// </summary>
		private void FindLayer(long thickness)
		{
			long exdim = 0;
			long dimdif;
			long dimen2 = 0;
